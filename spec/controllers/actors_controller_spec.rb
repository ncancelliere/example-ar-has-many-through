  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved actor as @actor" do
        ...
        post :create, {:actor => { "name" => "invalid value" }}, valid_session
        assigns(:actor).should be_a_new(Actor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested actor" do
        ...
        Actor.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => actor.to_param, :actor => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the actor as @actor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Actor.any_instance.stub(:save).and_return(false)
        put :update, {:id => actor.to_param, :actor => { "name" => "invalid value" }}, valid_session
        assigns(:actor).should eq(actor)
      end
